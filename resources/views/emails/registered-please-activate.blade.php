...
<head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
        ...
        .button {
            background-color: #0f7cda;
            border-top: 10px solid #0f7cda;
            border-right: 18px solid #0f7cda;
            border-bottom: 10px solid #0f7cda;
            border-left: 18px solid #0f7cda;
        ...
        .button--green {
            ...
            border-top: 10px solid #36bc71;
            border-right: 18px solid #36bc71;
            border-bottom: 10px solid #36bc71;
            border-left: 18px solid #36bc71;
        }

        .button--red {
            background-color: #ff804c;
            border-top: 10px solid #ff804c;
            border-right: 18px solid #ff804c;
            border-bottom: 10px solid #ff804c;
            border-left: 18px solid #ff804c;
        }
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{{$action_url}}" class="f-fallback button" target="_blank">Verify your email.</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                        ...
                        <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                                <td class="content-cell" align="center">
                                    <p class="f-fallback sub align-center">&copy; 2019 {{$app_name}}. All rights reserved.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
